...
CREATE OR REPLACE TABLE HNEACOSTA1/MLNOT (
    ...
    CONSTRAINT FK_MLNOT_MLNCT FOREIGN KEY (codigo_banco, codigo_de_notificacion, nivel)
        REFERENCES HNEACOSTA1/MLNCT (codigo_banco, codigo_de_notificacion, nivel)
)
RCDFMT MNOTR;

RENAME TABLE HNEACOSTA1/MLNOT
    TO MLNOT FOR SYSTEM NAME MLNOT;

COMMENT ON TABLE HNEACOSTA1/MLNOT IS
    'Datos a Imprimir en Notificaciones - Modulo 01 Archivos Comunes Taller IBM i';

LABEL ON TABLE HNEACOSTA1/MLNOT IS
    'Datos Notificaciones';

COMMENT ON COLUMN HNEACOSTA1/MLNOT.codigo_banco            IS 'Codigo del banco que genera la notificacion; parte de la PK';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.fecha_proceso           IS 'Fecha del proceso batch que genero la notificacion; parte de la PK';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.numero_cuenta           IS 'Numero de cuenta del cliente destinatario de la notificacion; parte de la PK';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.codigo_de_notificacion  IS 'Codigo del tipo de notificacion referenciado en MLNCT; parte de la PK';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.nivel                   IS 'Nivel jerarquico de la notificacion referenciado en MLNCT; parte de la PK';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.descripcion             IS 'Descripcion del contenido de la notificacion generada';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.valor_texto             IS 'Dato de texto variable a imprimir en la notificacion';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.valor_numerico          IS 'Dato numerico variable a imprimir en la notificacion si aplica';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.vigencia_desde          IS 'Fecha desde la cual el dato de notificacion es vigente';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.vigencia_hasta          IS 'Fecha hasta la cual el dato de notificacion es vigente';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.orden_visualizacion     IS 'Numero de orden de impresion del dato en la notificacion';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.usuario_creacion        IS 'Usuario o proceso batch que genero el registro de notificacion';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.usuario_actualizacion   IS 'Usuario del sistema que realizo la ultima modificacion';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.version_registro        IS 'Contador de versiones para control de concurrencia optimista';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.observaciones           IS 'Notas adicionales sobre el dato de notificacion';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.estado_registro         IS 'Estado logico del registro: A=Activo, I=Inactivo';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.created_at              IS 'Fecha y hora exacta de creacion del registro';
COMMENT ON COLUMN HNEACOSTA1/MLNOT.updated_at              IS 'Fecha y hora de la ultima actualizacion del registro';

LABEL ON COLUMN HNEACOSTA1/MLNOT (
...
CREATE INDEX HNEACOSTA1/IDX_MLNOT_F ON HNEACOSTA1/MLNOT (fecha_proceso);
CREATE INDEX HNEACOSTA1/IDX_MLNOT_C ON HNEACOSTA1/MLNOT (created_at);
